...
kern_init(void) {
  ...
  10002c:	e8 33 15 00 00       	call   101564 <cons_init>
  ...
  10005a:	e8 48 16 00 00       	call   1016a7 <pic_init>
    idt_init();                 // init interrupt descriptor table
  10005f:	e8 9a 17 00 00       	call   1017fe <idt_init>

    clock_init();               // init clock interrupt
  100064:	e8 ee 0c 00 00       	call   100d57 <clock_init>
    intr_enable();              // enable irq interrupt
  100069:	e8 a7 15 00 00       	call   101615 <intr_enable>
...
grade_backtrace2(int arg0, int arg1, int arg2, int arg3) {
  ...
  10008d:	e8 f7 0b 00 00       	call   100c89 <mon_backtrace>
}
  100092:	c9                   	leave  
  100093:	c3                   	ret    
...
cputch(int c, int *cnt) {
  ...
  1002cb:	e8 c0 12 00 00       	call   101590 <cons_putc>
    (*cnt) ++;
...
cputchar(int c) {
  ...
  100344:	e8 47 12 00 00       	call   101590 <cons_putc>
}
  100349:	c9                   	leave  
  10034a:	c3                   	ret    
...
getchar(void) {
  ...
  10039d:	83 ec 18             	sub    $0x18,%esp
    int c;
    while ((c = cons_getc()) == 0)
  1003a0:	e8 14 12 00 00       	call   1015b9 <cons_getc>
...
debuginfo_eip(uintptr_t addr, struct eipdebuginfo *info) {
  ...
  10055e:	c7 45 e8 0d d4 10 00 	movl   $0x10d40d,-0x18(%ebp)
...
read_ebp(void) {
  ...
  1009b0:	e9 8d 00 00 00       	jmp    100a42 <print_stackframe+0xb2>
		if (ebp == 0) break;
  1009b5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  1009b9:	75 05                	jne    1009c0 <print_stackframe+0x30>
  1009bb:	e9 8c 00 00 00       	jmp    100a4c <print_stackframe+0xbc>
  ...
  1009ce:	c7 04 24 88 35 10 00 	movl   $0x103588,(%esp)
  ...
  1009e1:	eb 28                	jmp    100a0b <print_stackframe+0x7b>
  ...
  1009f2:	83 c0 08             	add    $0x8,%eax
  1009f5:	8b 00                	mov    (%eax),%eax
  1009f7:	89 44 24 04          	mov    %eax,0x4(%esp)
  1009fb:	c7 04 24 a4 35 10 00 	movl   $0x1035a4,(%esp)
  100a02:	e8 0b f9 ff ff       	call   100312 <cprintf>
  100a07:	83 45 e8 01          	addl   $0x1,-0x18(%ebp)
  100a0b:	83 7d e8 03          	cmpl   $0x3,-0x18(%ebp)
  100a0f:	7e d2                	jle    1009e3 <print_stackframe+0x53>
		cprintf("\n");
  100a11:	c7 04 24 ac 35 10 00 	movl   $0x1035ac,(%esp)
  ...
  100a46:	0f 8e 69 ff ff ff    	jle    1009b5 <print_stackframe+0x25>
		cprintf("\n");
		print_debuginfo(eip - 1);
		eip = *((uint32_t *) ebp + 1);
		ebp = *((uint32_t *) ebp);
...
parse(char *buf, char **argv) {
  ...
  100a80:	c7 04 24 30 36 10 00 	movl   $0x103630,(%esp)
  100a87:	e8 24 26 00 00       	call   1030b0 <strchr>
  ...
  100aa9:	00 
  100aaa:	c7 04 24 35 36 10 00 	movl   $0x103635,(%esp)
  100ab1:	e8 5c f8 ff ff       	call   100312 <cprintf>
        }
        argv[argc ++] = buf;
  ...
  100aed:	c7 04 24 30 36 10 00 	movl   $0x103630,(%esp)
  100af4:	e8 b7 25 00 00       	call   1030b0 <strchr>
...
runcmd(char *buf, struct trapframe *tf) {
  ...
  100b59:	e8 b3 24 00 00       	call   103011 <strcmp>
  ...
  100ba7:	c7 04 24 53 36 10 00 	movl   $0x103653,(%esp)
  100bae:	e8 5f f7 ff ff       	call   100312 <cprintf>
    return 0;
...
kmonitor(struct trapframe *tf) {
  ...
  100bc0:	c7 04 24 6c 36 10 00 	movl   $0x10366c,(%esp)
  100bc7:	e8 46 f7 ff ff       	call   100312 <cprintf>
    cprintf("Type 'help' for a list of commands.\n");
  100bcc:	c7 04 24 94 36 10 00 	movl   $0x103694,(%esp)
  ...
  100be4:	e8 6c 0d 00 00       	call   101955 <print_trapframe>
    }

    char *buf;
    while (1) {
        if ((buf = readline("K> ")) != NULL) {
  100be9:	c7 04 24 b9 36 10 00 	movl   $0x1036b9,(%esp)
  100bf0:	e8 14 f6 ff ff       	call   100209 <readline>
...
mon_help(int argc, char **argv, struct trapframe *tf) {
  ...
  100c58:	c7 04 24 bd 36 10 00 	movl   $0x1036bd,(%esp)
  100c5f:	e8 ae f6 ff ff       	call   100312 <cprintf>
...
mon_kerninfo(int argc, char **argv, struct trapframe *tf) {
  ...
  100c7a:	83 ec 08             	sub    $0x8,%esp
    print_kerninfo();
  100c7d:	e8 c4 fb ff ff       	call   100846 <print_kerninfo>
    return 0;
...
mon_backtrace(int argc, char **argv, struct trapframe *tf) {
  ...
  100c8c:	83 ec 08             	sub    $0x8,%esp
    print_stackframe();
  100c8f:	e8 fc fc ff ff       	call   100990 <print_stackframe>
    return 0;
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  100ca8:	74 02                	je     100cac <__panic+0x11>
        goto panic_dead;
  100caa:	eb 48                	jmp    100cf4 <__panic+0x59>
    }
    is_panic = 1;
  ...
  100cca:	c7 04 24 c6 36 10 00 	movl   $0x1036c6,(%esp)
  100cd1:	e8 3c f6 ff ff       	call   100312 <cprintf>
    vcprintf(fmt, ap);
  ...
  100ce3:	e8 f7 f5 ff ff       	call   1002df <vcprintf>
    cprintf("\n");
  100ce8:	c7 04 24 e2 36 10 00 	movl   $0x1036e2,(%esp)
  100cef:	e8 1e f6 ff ff       	call   100312 <cprintf>
    va_end(ap);

panic_dead:
    intr_disable();
  100cf4:	e8 22 09 00 00       	call   10161b <intr_disable>
    while (1) {
        kmonitor(NULL);
  100cf9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  100d00:	e8 b5 fe ff ff       	call   100bba <kmonitor>
    }
  100d05:	eb f2                	jmp    100cf9 <__panic+0x5e>
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  100d0a:	83 ec 28             	sub    $0x28,%esp
    va_list ap;
    va_start(ap, fmt);
  100d0d:	8d 45 14             	lea    0x14(%ebp),%eax
  100d10:	89 45 f4             	mov    %eax,-0xc(%ebp)
    cprintf("kernel warning at %s:%d:\n    ", file, line);
  100d13:	8b 45 0c             	mov    0xc(%ebp),%eax
  100d16:	89 44 24 08          	mov    %eax,0x8(%esp)
  100d1a:	8b 45 08             	mov    0x8(%ebp),%eax
  100d1d:	89 44 24 04          	mov    %eax,0x4(%esp)
  100d21:	c7 04 24 e4 36 10 00 	movl   $0x1036e4,(%esp)
  100d28:	e8 e5 f5 ff ff       	call   100312 <cprintf>
    vcprintf(fmt, ap);
  100d2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  100d30:	89 44 24 04          	mov    %eax,0x4(%esp)
  100d34:	8b 45 10             	mov    0x10(%ebp),%eax
  100d37:	89 04 24             	mov    %eax,(%esp)
  100d3a:	e8 a0 f5 ff ff       	call   1002df <vcprintf>
    cprintf("\n");
  100d3f:	c7 04 24 e2 36 10 00 	movl   $0x1036e2,(%esp)
  100d46:	e8 c7 f5 ff ff       	call   100312 <cprintf>
    va_end(ap);
}
  100d4b:	c9                   	leave  
  100d4c:	c3                   	ret    

00100d4d <is_kernel_panic>:
...
is_kernel_panic(void) {
  ...
  100d4e:	89 e5                	mov    %esp,%ebp
    return is_panic;
  100d50:	a1 40 ee 10 00       	mov    0x10ee40,%eax
}
  100d55:	5d                   	pop    %ebp
  100d56:	c3                   	ret    
...
clock_init(void) {
  ...
  100d5a:	83 ec 28             	sub    $0x28,%esp
  100d5d:	66 c7 45 f6 43 00    	movw   $0x43,-0xa(%ebp)
  100d63:	c6 45 f5 34          	movb   $0x34,-0xb(%ebp)
            : "memory", "cc");
}
...
outb(uint16_t port, uint8_t data) {
  ...
  100d67:	0f b6 45 f5          	movzbl -0xb(%ebp),%eax
  100d6b:	0f b7 55 f6          	movzwl -0xa(%ebp),%edx
  100d6f:	ee                   	out    %al,(%dx)
  ...
  100d82:	ee                   	out    %al,(%dx)
  100d83:	66 c7 45 ee 40 00    	movw   $0x40,-0x12(%ebp)
  100d89:	c6 45 ed 2e          	movb   $0x2e,-0x13(%ebp)
  100d8d:	0f b6 45 ed          	movzbl -0x13(%ebp),%eax
  100d91:	0f b7 55 ee          	movzwl -0x12(%ebp),%edx
  100d95:	ee                   	out    %al,(%dx)
    ...
    ticks = 0;
  100d96:	c7 05 08 f9 10 00 00 	movl   $0x0,0x10f908
  100d9d:	00 00 00 

    cprintf("++ setup timer interrupts\n");
  100da0:	c7 04 24 02 37 10 00 	movl   $0x103702,(%esp)
  100da7:	e8 66 f5 ff ff       	call   100312 <cprintf>
    pic_enable(IRQ_TIMER);
  100dac:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  100db3:	e8 c1 08 00 00       	call   101679 <pic_enable>
}
  100db8:	c9                   	leave  
  100db9:	c3                   	ret    
...
inb(uint16_t port) {
  ...
  100dcc:	ec                   	in     (%dx),%al
  100dcd:	88 45 fd             	mov    %al,-0x3(%ebp)
  ...
  100de0:	66 c7 45 f6 84 00    	movw   $0x84,-0xa(%ebp)
  100de6:	0f b7 45 f6          	movzwl -0xa(%ebp),%eax
  100dea:	89 c2                	mov    %eax,%edx
  100dec:	ec                   	in     (%dx),%al
  100ded:	88 45 f5             	mov    %al,-0xb(%ebp)
  100df0:	66 c7 45 f2 84 00    	movw   $0x84,-0xe(%ebp)
  100df6:	0f b7 45 f2          	movzwl -0xe(%ebp),%eax
  100dfa:	89 c2                	mov    %eax,%edx
  100dfc:	ec                   	in     (%dx),%al
  100dfd:	88 45 f1             	mov    %al,-0xf(%ebp)
    inb(0x84);
    inb(0x84);
    inb(0x84);
    inb(0x84);
...
cga_init(void) {
  ...
  100e59:	0f b7 c0             	movzwl %ax,%eax
  100e5c:	66 89 45 f2          	mov    %ax,-0xe(%ebp)
  100e60:	c6 45 f1 0e          	movb   $0xe,-0xf(%ebp)
            : "memory", "cc");
}
...
outb(uint16_t port, uint8_t data) {
    asm volatile ("outb %0, %1" :: "a" (data), "d" (port));
  100e64:	0f b6 45 f1          	movzbl -0xf(%ebp),%eax
  100e68:	0f b7 55 f2          	movzwl -0xe(%ebp),%edx
  100e6c:	ee                   	out    %al,(%dx)
    pos = inb(addr_6845 + 1) << 8;
  100e6d:	0f b7 05 66 ee 10 00 	movzwl 0x10ee66,%eax
  100e74:	83 c0 01             	add    $0x1,%eax
  100e77:	0f b7 c0             	movzwl %ax,%eax
  100e7a:	66 89 45 ee          	mov    %ax,-0x12(%ebp)
static inline void ltr(uint16_t sel) __attribute__((always_inline));
...
inb(uint16_t port) {
    uint8_t data;
    asm volatile ("inb %1, %0" : "=a" (data) : "d" (port));
  100e7e:	0f b7 45 ee          	movzwl -0x12(%ebp),%eax
  100e82:	89 c2                	mov    %eax,%edx
  100e84:	ec                   	in     (%dx),%al
  100e85:	88 45 ed             	mov    %al,-0x13(%ebp)
    return data;
  100e88:	0f b6 45 ed          	movzbl -0x13(%ebp),%eax
  100e8c:	0f b6 c0             	movzbl %al,%eax
  100e8f:	c1 e0 08             	shl    $0x8,%eax
  100e92:	89 45 f4             	mov    %eax,-0xc(%ebp)
    outb(addr_6845, 15);
  100e95:	0f b7 05 66 ee 10 00 	movzwl 0x10ee66,%eax
  100e9c:	0f b7 c0             	movzwl %ax,%eax
  100e9f:	66 89 45 ea          	mov    %ax,-0x16(%ebp)
  100ea3:	c6 45 e9 0f          	movb   $0xf,-0x17(%ebp)
            : "memory", "cc");
}
...
outb(uint16_t port, uint8_t data) {
    asm volatile ("outb %0, %1" :: "a" (data), "d" (port));
  100ea7:	0f b6 45 e9          	movzbl -0x17(%ebp),%eax
  100eab:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
  100eaf:	ee                   	out    %al,(%dx)
    pos |= inb(addr_6845 + 1);
  100eb0:	0f b7 05 66 ee 10 00 	movzwl 0x10ee66,%eax
  100eb7:	83 c0 01             	add    $0x1,%eax
  100eba:	0f b7 c0             	movzwl %ax,%eax
  100ebd:	66 89 45 e6          	mov    %ax,-0x1a(%ebp)
static inline void ltr(uint16_t sel) __attribute__((always_inline));
...
inb(uint16_t port) {
    uint8_t data;
    asm volatile ("inb %1, %0" : "=a" (data) : "d" (port));
  100ec1:	0f b7 45 e6          	movzwl -0x1a(%ebp),%eax
  100ec5:	89 c2                	mov    %eax,%edx
  100ec7:	ec                   	in     (%dx),%al
  100ec8:	88 45 e5             	mov    %al,-0x1b(%ebp)
    return data;
...
serial_init(void) {
  ...
  100eeb:	83 ec 48             	sub    $0x48,%esp
  100eee:	66 c7 45 f6 fa 03    	movw   $0x3fa,-0xa(%ebp)
  100ef4:	c6 45 f5 00          	movb   $0x0,-0xb(%ebp)
            : "memory", "cc");
}
...
outb(uint16_t port, uint8_t data) {
    asm volatile ("outb %0, %1" :: "a" (data), "d" (port));
  100ef8:	0f b6 45 f5          	movzbl -0xb(%ebp),%eax
  100efc:	0f b7 55 f6          	movzwl -0xa(%ebp),%edx
  100f00:	ee                   	out    %al,(%dx)
  100f01:	66 c7 45 f2 fb 03    	movw   $0x3fb,-0xe(%ebp)
  100f07:	c6 45 f1 80          	movb   $0x80,-0xf(%ebp)
  100f0b:	0f b6 45 f1          	movzbl -0xf(%ebp),%eax
  100f0f:	0f b7 55 f2          	movzwl -0xe(%ebp),%edx
  100f13:	ee                   	out    %al,(%dx)
  100f14:	66 c7 45 ee f8 03    	movw   $0x3f8,-0x12(%ebp)
  100f1a:	c6 45 ed 0c          	movb   $0xc,-0x13(%ebp)
  100f1e:	0f b6 45 ed          	movzbl -0x13(%ebp),%eax
  100f22:	0f b7 55 ee          	movzwl -0x12(%ebp),%edx
  100f26:	ee                   	out    %al,(%dx)
  100f27:	66 c7 45 ea f9 03    	movw   $0x3f9,-0x16(%ebp)
  100f2d:	c6 45 e9 00          	movb   $0x0,-0x17(%ebp)
  100f31:	0f b6 45 e9          	movzbl -0x17(%ebp),%eax
  100f35:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
  100f39:	ee                   	out    %al,(%dx)
  100f3a:	66 c7 45 e6 fb 03    	movw   $0x3fb,-0x1a(%ebp)
  100f40:	c6 45 e5 03          	movb   $0x3,-0x1b(%ebp)
  100f44:	0f b6 45 e5          	movzbl -0x1b(%ebp),%eax
  100f48:	0f b7 55 e6          	movzwl -0x1a(%ebp),%edx
  100f4c:	ee                   	out    %al,(%dx)
  100f4d:	66 c7 45 e2 fc 03    	movw   $0x3fc,-0x1e(%ebp)
  100f53:	c6 45 e1 00          	movb   $0x0,-0x1f(%ebp)
  100f57:	0f b6 45 e1          	movzbl -0x1f(%ebp),%eax
  100f5b:	0f b7 55 e2          	movzwl -0x1e(%ebp),%edx
  100f5f:	ee                   	out    %al,(%dx)
  100f60:	66 c7 45 de f9 03    	movw   $0x3f9,-0x22(%ebp)
  100f66:	c6 45 dd 01          	movb   $0x1,-0x23(%ebp)
  100f6a:	0f b6 45 dd          	movzbl -0x23(%ebp),%eax
  100f6e:	0f b7 55 de          	movzwl -0x22(%ebp),%edx
  100f72:	ee                   	out    %al,(%dx)
  100f73:	66 c7 45 da fd 03    	movw   $0x3fd,-0x26(%ebp)
static inline void ltr(uint16_t sel) __attribute__((always_inline));
...
inb(uint16_t port) {
    uint8_t data;
    asm volatile ("inb %1, %0" : "=a" (data) : "d" (port));
  100f79:	0f b7 45 da          	movzwl -0x26(%ebp),%eax
  100f7d:	89 c2                	mov    %eax,%edx
  100f7f:	ec                   	in     (%dx),%al
  100f80:	88 45 d9             	mov    %al,-0x27(%ebp)
    return data;
  ...
  100f94:	66 c7 45 d6 fa 03    	movw   $0x3fa,-0x2a(%ebp)
static inline void ltr(uint16_t sel) __attribute__((always_inline));
...
inb(uint16_t port) {
    uint8_t data;
    asm volatile ("inb %1, %0" : "=a" (data) : "d" (port));
  100f9a:	0f b7 45 d6          	movzwl -0x2a(%ebp),%eax
  100f9e:	89 c2                	mov    %eax,%edx
  100fa0:	ec                   	in     (%dx),%al
  100fa1:	88 45 d5             	mov    %al,-0x2b(%ebp)
  100fa4:	66 c7 45 d2 f8 03    	movw   $0x3f8,-0x2e(%ebp)
  100faa:	0f b7 45 d2          	movzwl -0x2e(%ebp),%eax
  100fae:	89 c2                	mov    %eax,%edx
  100fb0:	ec                   	in     (%dx),%al
  100fb1:	88 45 d1             	mov    %al,-0x2f(%ebp)
  ...
  100fbb:	74 0c                	je     100fc9 <serial_init+0xe1>
        pic_enable(IRQ_COM1);
  100fbd:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  100fc4:	e8 b0 06 00 00       	call   101679 <pic_enable>
    }
}
  100fc9:	c9                   	leave  
  100fca:	c3                   	ret    

00100fcb <lpt_putc_sub>:

static void
lpt_putc_sub(int c) {
  100fcb:	55                   	push   %ebp
  100fcc:	89 e5                	mov    %esp,%ebp
  100fce:	83 ec 20             	sub    $0x20,%esp
    int i;
    for (i = 0; !(inb(LPTPORT + 1) & 0x80) && i < 12800; i ++) {
  100fd1:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
  100fd8:	eb 09                	jmp    100fe3 <lpt_putc_sub+0x18>
        delay();
  100fda:	e8 db fd ff ff       	call   100dba <delay>
}
...
lpt_putc_sub(int c) {
    int i;
    for (i = 0; !(inb(LPTPORT + 1) & 0x80) && i < 12800; i ++) {
  100fdf:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  100fe3:	66 c7 45 fa 79 03    	movw   $0x379,-0x6(%ebp)
  100fe9:	0f b7 45 fa          	movzwl -0x6(%ebp),%eax
  100fed:	89 c2                	mov    %eax,%edx
  100fef:	ec                   	in     (%dx),%al
  100ff0:	88 45 f9             	mov    %al,-0x7(%ebp)
    return data;
  100ff3:	0f b6 45 f9          	movzbl -0x7(%ebp),%eax
  100ff7:	84 c0                	test   %al,%al
  100ff9:	78 09                	js     101004 <lpt_putc_sub+0x39>
  100ffb:	81 7d fc ff 31 00 00 	cmpl   $0x31ff,-0x4(%ebp)
  101002:	7e d6                	jle    100fda <lpt_putc_sub+0xf>
        delay();
    }
    outb(LPTPORT + 0, c);
  101004:	8b 45 08             	mov    0x8(%ebp),%eax
  101007:	0f b6 c0             	movzbl %al,%eax
  10100a:	66 c7 45 f6 78 03    	movw   $0x378,-0xa(%ebp)
  101010:	88 45 f5             	mov    %al,-0xb(%ebp)
            : "memory", "cc");
}
...
outb(uint16_t port, uint8_t data) {
    asm volatile ("outb %0, %1" :: "a" (data), "d" (port));
  101013:	0f b6 45 f5          	movzbl -0xb(%ebp),%eax
  101017:	0f b7 55 f6          	movzwl -0xa(%ebp),%edx
  10101b:	ee                   	out    %al,(%dx)
  10101c:	66 c7 45 f2 7a 03    	movw   $0x37a,-0xe(%ebp)
  101022:	c6 45 f1 0d          	movb   $0xd,-0xf(%ebp)
  101026:	0f b6 45 f1          	movzbl -0xf(%ebp),%eax
  10102a:	0f b7 55 f2          	movzwl -0xe(%ebp),%edx
  10102e:	ee                   	out    %al,(%dx)
  10102f:	66 c7 45 ee 7a 03    	movw   $0x37a,-0x12(%ebp)
  101035:	c6 45 ed 08          	movb   $0x8,-0x13(%ebp)
  101039:	0f b6 45 ed          	movzbl -0x13(%ebp),%eax
  10103d:	0f b7 55 ee          	movzwl -0x12(%ebp),%edx
  101041:	ee                   	out    %al,(%dx)
...
lpt_putc(int c) {
  ...
  101047:	83 ec 04             	sub    $0x4,%esp
    if (c != '\b') {
  10104a:	83 7d 08 08          	cmpl   $0x8,0x8(%ebp)
  10104e:	74 0d                	je     10105d <lpt_putc+0x19>
        lpt_putc_sub(c);
  101050:	8b 45 08             	mov    0x8(%ebp),%eax
  101053:	89 04 24             	mov    %eax,(%esp)
  101056:	e8 70 ff ff ff       	call   100fcb <lpt_putc_sub>
  10105b:	eb 24                	jmp    101081 <lpt_putc+0x3d>
    }
    else {
        lpt_putc_sub('\b');
  10105d:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  101064:	e8 62 ff ff ff       	call   100fcb <lpt_putc_sub>
        lpt_putc_sub(' ');
  101069:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
  101070:	e8 56 ff ff ff       	call   100fcb <lpt_putc_sub>
        lpt_putc_sub('\b');
  101075:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  10107c:	e8 4a ff ff ff       	call   100fcb <lpt_putc_sub>
    }
}
  101081:	c9                   	leave  
  101082:	c3                   	ret    
...
cga_putc(int c) {
  ...
  101086:	53                   	push   %ebx
  101087:	83 ec 34             	sub    $0x34,%esp
    // set black on white
    if (!(c & ~0xFF)) {
  10108a:	8b 45 08             	mov    0x8(%ebp),%eax
  10108d:	b0 00                	mov    $0x0,%al
  10108f:	85 c0                	test   %eax,%eax
  101091:	75 07                	jne    10109a <cga_putc+0x17>
        c |= 0x0700;
  101093:	81 4d 08 00 07 00 00 	orl    $0x700,0x8(%ebp)
    }

    switch (c & 0xff) {
  10109a:	8b 45 08             	mov    0x8(%ebp),%eax
  10109d:	0f b6 c0             	movzbl %al,%eax
  1010a0:	83 f8 0a             	cmp    $0xa,%eax
  1010a3:	74 4c                	je     1010f1 <cga_putc+0x6e>
  1010a5:	83 f8 0d             	cmp    $0xd,%eax
  1010a8:	74 57                	je     101101 <cga_putc+0x7e>
  1010aa:	83 f8 08             	cmp    $0x8,%eax
  1010ad:	0f 85 88 00 00 00    	jne    10113b <cga_putc+0xb8>
    case '\b':
        if (crt_pos > 0) {
  1010b3:	0f b7 05 64 ee 10 00 	movzwl 0x10ee64,%eax
  1010ba:	66 85 c0             	test   %ax,%ax
  1010bd:	74 30                	je     1010ef <cga_putc+0x6c>
            crt_pos --;
  1010bf:	0f b7 05 64 ee 10 00 	movzwl 0x10ee64,%eax
  1010c6:	83 e8 01             	sub    $0x1,%eax
  1010c9:	66 a3 64 ee 10 00    	mov    %ax,0x10ee64
            crt_buf[crt_pos] = (c & ~0xff) | ' ';
  1010cf:	a1 60 ee 10 00       	mov    0x10ee60,%eax
  1010d4:	0f b7 15 64 ee 10 00 	movzwl 0x10ee64,%edx
  1010db:	0f b7 d2             	movzwl %dx,%edx
  1010de:	01 d2                	add    %edx,%edx
  1010e0:	01 c2                	add    %eax,%edx
  1010e2:	8b 45 08             	mov    0x8(%ebp),%eax
  1010e5:	b0 00                	mov    $0x0,%al
  1010e7:	83 c8 20             	or     $0x20,%eax
  1010ea:	66 89 02             	mov    %ax,(%edx)
        }
        break;
  1010ed:	eb 72                	jmp    101161 <cga_putc+0xde>
  1010ef:	eb 70                	jmp    101161 <cga_putc+0xde>
    case '\n':
        crt_pos += CRT_COLS;
  1010f1:	0f b7 05 64 ee 10 00 	movzwl 0x10ee64,%eax
  1010f8:	83 c0 50             	add    $0x50,%eax
  1010fb:	66 a3 64 ee 10 00    	mov    %ax,0x10ee64
    case '\r':
        crt_pos -= (crt_pos % CRT_COLS);
  101101:	0f b7 1d 64 ee 10 00 	movzwl 0x10ee64,%ebx
  101108:	0f b7 0d 64 ee 10 00 	movzwl 0x10ee64,%ecx
  10110f:	0f b7 c1             	movzwl %cx,%eax
  101112:	69 c0 cd cc 00 00    	imul   $0xcccd,%eax,%eax
  101118:	c1 e8 10             	shr    $0x10,%eax
  10111b:	89 c2                	mov    %eax,%edx
  10111d:	66 c1 ea 06          	shr    $0x6,%dx
  101121:	89 d0                	mov    %edx,%eax
  101123:	c1 e0 02             	shl    $0x2,%eax
  101126:	01 d0                	add    %edx,%eax
  101128:	c1 e0 04             	shl    $0x4,%eax
  10112b:	29 c1                	sub    %eax,%ecx
  10112d:	89 ca                	mov    %ecx,%edx
  10112f:	89 d8                	mov    %ebx,%eax
  101131:	29 d0                	sub    %edx,%eax
  101133:	66 a3 64 ee 10 00    	mov    %ax,0x10ee64
        break;
  101139:	eb 26                	jmp    101161 <cga_putc+0xde>
    default:
        crt_buf[crt_pos ++] = c;     // write the character
  10113b:	8b 0d 60 ee 10 00    	mov    0x10ee60,%ecx
  101141:	0f b7 05 64 ee 10 00 	movzwl 0x10ee64,%eax
  101148:	8d 50 01             	lea    0x1(%eax),%edx
  10114b:	66 89 15 64 ee 10 00 	mov    %dx,0x10ee64
  101152:	0f b7 c0             	movzwl %ax,%eax
  101155:	01 c0                	add    %eax,%eax
  101157:	8d 14 01             	lea    (%ecx,%eax,1),%edx
  10115a:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  10116c:	76 5b                	jbe    1011c9 <cga_putc+0x146>
        int i;
  ...
  10117e:	c7 44 24 08 00 0f 00 	movl   $0xf00,0x8(%esp)
  101185:	00 
  101186:	89 54 24 04          	mov    %edx,0x4(%esp)
  10118a:	89 04 24             	mov    %eax,(%esp)
  10118d:	e8 1c 21 00 00       	call   1032ae <memmove>
        for (i = CRT_SIZE - CRT_COLS; i < CRT_SIZE; i ++) {
  101192:	c7 45 f4 80 07 00 00 	movl   $0x780,-0xc(%ebp)
  101199:	eb 15                	jmp    1011b0 <cga_putc+0x12d>
            crt_buf[i] = 0x0700 | ' ';
  ...
  1011b7:	7e e2                	jle    10119b <cga_putc+0x118>
            crt_buf[i] = 0x0700 | ' ';
        }
        crt_pos -= CRT_COLS;
  ...
  1011d7:	c6 45 f1 0e          	movb   $0xe,-0xf(%ebp)
  1011db:	0f b6 45 f1          	movzbl -0xf(%ebp),%eax
  ...
  1011ff:	66 89 55 ee          	mov    %dx,-0x12(%ebp)
  101203:	88 45 ed             	mov    %al,-0x13(%ebp)
  101206:	0f b6 45 ed          	movzbl -0x13(%ebp),%eax
  10120a:	0f b7 55 ee          	movzwl -0x12(%ebp),%edx
  10120e:	ee                   	out    %al,(%dx)
    outb(addr_6845, 15);
  10120f:	0f b7 05 66 ee 10 00 	movzwl 0x10ee66,%eax
  101216:	0f b7 c0             	movzwl %ax,%eax
  101219:	66 89 45 ea          	mov    %ax,-0x16(%ebp)
  10121d:	c6 45 e9 0f          	movb   $0xf,-0x17(%ebp)
  101221:	0f b6 45 e9          	movzbl -0x17(%ebp),%eax
  101225:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
  101229:	ee                   	out    %al,(%dx)
  ...
  101241:	66 89 55 e6          	mov    %dx,-0x1a(%ebp)
  101245:	88 45 e5             	mov    %al,-0x1b(%ebp)
  101248:	0f b6 45 e5          	movzbl -0x1b(%ebp),%eax
  10124c:	0f b7 55 e6          	movzwl -0x1a(%ebp),%edx
  101250:	ee                   	out    %al,(%dx)
}
  101251:	83 c4 34             	add    $0x34,%esp
  101254:	5b                   	pop    %ebx
  101255:	5d                   	pop    %ebp
  101256:	c3                   	ret    
...
serial_putc_sub(int c) {
  ...
  101264:	eb 09                	jmp    10126f <serial_putc_sub+0x18>
        delay();
  101266:	e8 4f fb ff ff       	call   100dba <delay>
}
...
serial_putc(int c) {
  ...
  1012b3:	83 ec 04             	sub    $0x4,%esp
    if (c != '\b') {
  1012b6:	83 7d 08 08          	cmpl   $0x8,0x8(%ebp)
  1012ba:	74 0d                	je     1012c9 <serial_putc+0x19>
        serial_putc_sub(c);
  1012bc:	8b 45 08             	mov    0x8(%ebp),%eax
  1012bf:	89 04 24             	mov    %eax,(%esp)
  1012c2:	e8 90 ff ff ff       	call   101257 <serial_putc_sub>
  1012c7:	eb 24                	jmp    1012ed <serial_putc+0x3d>
    }
    else {
        serial_putc_sub('\b');
  1012c9:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  1012d0:	e8 82 ff ff ff       	call   101257 <serial_putc_sub>
        serial_putc_sub(' ');
  1012d5:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
  1012dc:	e8 76 ff ff ff       	call   101257 <serial_putc_sub>
        serial_putc_sub('\b');
  1012e1:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  1012e8:	e8 6a ff ff ff       	call   101257 <serial_putc_sub>
    }
}
  1012ed:	c9                   	leave  
  1012ee:	c3                   	ret    
...
serial_intr(void) {
  ...
  101394:	83 ec 18             	sub    $0x18,%esp
    if (serial_exists) {
  101397:	a1 68 ee 10 00       	mov    0x10ee68,%eax
  10139c:	85 c0                	test   %eax,%eax
  10139e:	74 0c                	je     1013ac <serial_intr+0x1b>
        cons_intr(serial_proc_data);
  1013a0:	c7 04 24 3a 13 10 00 	movl   $0x10133a,(%esp)
  1013a7:	e8 43 ff ff ff       	call   1012ef <cons_intr>
    }
}
  1013ac:	c9                   	leave  
  1013ad:	c3                   	ret    

001013ae <kbd_proc_data>:
 *
...
kbd_proc_data(void) {
  ...
  1013b1:	83 ec 38             	sub    $0x38,%esp
  1013b4:	66 c7 45 f0 64 00    	movw   $0x64,-0x10(%ebp)
static inline void ltr(uint16_t sel) __attribute__((always_inline));
...
inb(uint16_t port) {
  ...
  1013c0:	ec                   	in     (%dx),%al
  1013c1:	88 45 ef             	mov    %al,-0x11(%ebp)
    return data;
  1013c4:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
    int c;
    uint8_t data;
  ...
  1013d0:	75 0a                	jne    1013dc <kbd_proc_data+0x2e>
        return -1;
  1013d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  1013d7:	e9 59 01 00 00       	jmp    101535 <kbd_proc_data+0x187>
  1013dc:	66 c7 45 ec 60 00    	movw   $0x60,-0x14(%ebp)
static inline void ltr(uint16_t sel) __attribute__((always_inline));
...
inb(uint16_t port) {
    uint8_t data;
    asm volatile ("inb %1, %0" : "=a" (data) : "d" (port));
  1013e2:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
  ...
  1013f7:	75 17                	jne    101410 <kbd_proc_data+0x62>
        // E0 escape character
        shift |= E0ESC;
  ...
  10140b:	e9 25 01 00 00       	jmp    101535 <kbd_proc_data+0x187>
    } else if (data & 0x80) {
  101410:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
  101414:	84 c0                	test   %al,%al
  101416:	79 47                	jns    10145f <kbd_proc_data+0xb1>
        // Key released
        data = (shift & E0ESC ? data : data & 0x7F);
  101418:	a1 88 f0 10 00       	mov    0x10f088,%eax
  10141d:	83 e0 40             	and    $0x40,%eax
  101420:	85 c0                	test   %eax,%eax
  101422:	75 09                	jne    10142d <kbd_proc_data+0x7f>
  101424:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
  101428:	83 e0 7f             	and    $0x7f,%eax
  10142b:	eb 04                	jmp    101431 <kbd_proc_data+0x83>
  10142d:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
  101431:	88 45 f3             	mov    %al,-0xd(%ebp)
        shift &= ~(shiftcode[data] | E0ESC);
  101434:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
  101438:	0f b6 80 40 e0 10 00 	movzbl 0x10e040(%eax),%eax
  10143f:	83 c8 40             	or     $0x40,%eax
  101442:	0f b6 c0             	movzbl %al,%eax
  101445:	f7 d0                	not    %eax
  101447:	89 c2                	mov    %eax,%edx
  101449:	a1 88 f0 10 00       	mov    0x10f088,%eax
  10144e:	21 d0                	and    %edx,%eax
  101450:	a3 88 f0 10 00       	mov    %eax,0x10f088
        return 0;
  101455:	b8 00 00 00 00       	mov    $0x0,%eax
  10145a:	e9 d6 00 00 00       	jmp    101535 <kbd_proc_data+0x187>
    } else if (shift & E0ESC) {
  10145f:	a1 88 f0 10 00       	mov    0x10f088,%eax
  101464:	83 e0 40             	and    $0x40,%eax
  101467:	85 c0                	test   %eax,%eax
  101469:	74 11                	je     10147c <kbd_proc_data+0xce>
        // Last character was an E0 escape; or with 0x80
        data |= 0x80;
  10146b:	80 4d f3 80          	orb    $0x80,-0xd(%ebp)
        shift &= ~E0ESC;
  10146f:	a1 88 f0 10 00       	mov    0x10f088,%eax
  101474:	83 e0 bf             	and    $0xffffffbf,%eax
  101477:	a3 88 f0 10 00       	mov    %eax,0x10f088
    }

    shift |= shiftcode[data];
  10147c:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
  101480:	0f b6 80 40 e0 10 00 	movzbl 0x10e040(%eax),%eax
  101487:	0f b6 d0             	movzbl %al,%edx
  10148a:	a1 88 f0 10 00       	mov    0x10f088,%eax
  10148f:	09 d0                	or     %edx,%eax
  101491:	a3 88 f0 10 00       	mov    %eax,0x10f088
    shift ^= togglecode[data];
  101496:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
  10149a:	0f b6 80 40 e1 10 00 	movzbl 0x10e140(%eax),%eax
  1014a1:	0f b6 d0             	movzbl %al,%edx
  1014a4:	a1 88 f0 10 00       	mov    0x10f088,%eax
  1014a9:	31 d0                	xor    %edx,%eax
  1014ab:	a3 88 f0 10 00       	mov    %eax,0x10f088

    c = charcode[shift & (CTL | SHIFT)][data];
  1014b0:	a1 88 f0 10 00       	mov    0x10f088,%eax
  1014b5:	83 e0 03             	and    $0x3,%eax
  1014b8:	8b 14 85 40 e5 10 00 	mov    0x10e540(,%eax,4),%edx
  1014bf:	0f b6 45 f3          	movzbl -0xd(%ebp),%eax
  1014c3:	01 d0                	add    %edx,%eax
  1014c5:	0f b6 00             	movzbl (%eax),%eax
  1014c8:	0f b6 c0             	movzbl %al,%eax
  1014cb:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if (shift & CAPSLOCK) {
  1014ce:	a1 88 f0 10 00       	mov    0x10f088,%eax
  1014d3:	83 e0 08             	and    $0x8,%eax
  1014d6:	85 c0                	test   %eax,%eax
  1014d8:	74 22                	je     1014fc <kbd_proc_data+0x14e>
        if ('a' <= c && c <= 'z')
  1014da:	83 7d f4 60          	cmpl   $0x60,-0xc(%ebp)
  1014de:	7e 0c                	jle    1014ec <kbd_proc_data+0x13e>
  1014e0:	83 7d f4 7a          	cmpl   $0x7a,-0xc(%ebp)
  1014e4:	7f 06                	jg     1014ec <kbd_proc_data+0x13e>
            c += 'A' - 'a';
  1014e6:	83 6d f4 20          	subl   $0x20,-0xc(%ebp)
  1014ea:	eb 10                	jmp    1014fc <kbd_proc_data+0x14e>
        else if ('A' <= c && c <= 'Z')
  1014ec:	83 7d f4 40          	cmpl   $0x40,-0xc(%ebp)
  1014f0:	7e 0a                	jle    1014fc <kbd_proc_data+0x14e>
  1014f2:	83 7d f4 5a          	cmpl   $0x5a,-0xc(%ebp)
  1014f6:	7f 04                	jg     1014fc <kbd_proc_data+0x14e>
            c += 'a' - 'A';
  1014f8:	83 45 f4 20          	addl   $0x20,-0xc(%ebp)
    }

    // Process special keys
    // Ctrl-Alt-Del: reboot
    if (!(~shift & (CTL | ALT)) && c == KEY_DEL) {
  1014fc:	a1 88 f0 10 00       	mov    0x10f088,%eax
  101501:	f7 d0                	not    %eax
  101503:	83 e0 06             	and    $0x6,%eax
  101506:	85 c0                	test   %eax,%eax
  101508:	75 28                	jne    101532 <kbd_proc_data+0x184>
  10150a:	81 7d f4 e9 00 00 00 	cmpl   $0xe9,-0xc(%ebp)
  101511:	75 1f                	jne    101532 <kbd_proc_data+0x184>
        cprintf("Rebooting!\n");
  101513:	c7 04 24 1d 37 10 00 	movl   $0x10371d,(%esp)
  10151a:	e8 f3 ed ff ff       	call   100312 <cprintf>
  10151f:	66 c7 45 e8 92 00    	movw   $0x92,-0x18(%ebp)
  101525:	c6 45 e7 03          	movb   $0x3,-0x19(%ebp)
            : "memory", "cc");
}
...
outb(uint16_t port, uint8_t data) {
    asm volatile ("outb %0, %1" :: "a" (data), "d" (port));
  101529:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
  10152d:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
  101531:	ee                   	out    %al,(%dx)
        outb(0x92, 0x3); // courtesy of Chris Frost
    }
    return c;
  101532:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
  101535:	c9                   	leave  
  101536:	c3                   	ret    
...
kbd_intr(void) {
  ...
  10153d:	c7 04 24 ae 13 10 00 	movl   $0x1013ae,(%esp)
  101544:	e8 a6 fd ff ff       	call   1012ef <cons_intr>
}
  101549:	c9                   	leave  
  10154a:	c3                   	ret    
...
kbd_init(void) {
  ...
  10154e:	83 ec 18             	sub    $0x18,%esp
    ...
    kbd_intr();
  101551:	e8 e1 ff ff ff       	call   101537 <kbd_intr>
    pic_enable(IRQ_KBD);
  101556:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  10155d:	e8 17 01 00 00       	call   101679 <pic_enable>
}
  101562:	c9                   	leave  
  101563:	c3                   	ret    
...
cons_init(void) {
  ...
  101567:	83 ec 18             	sub    $0x18,%esp
    cga_init();
  10156a:	e8 93 f8 ff ff       	call   100e02 <cga_init>
    serial_init();
  10156f:	e8 74 f9 ff ff       	call   100ee8 <serial_init>
    kbd_init();
  101574:	e8 d2 ff ff ff       	call   10154b <kbd_init>
    if (!serial_exists) {
  101579:	a1 68 ee 10 00       	mov    0x10ee68,%eax
  10157e:	85 c0                	test   %eax,%eax
  101580:	75 0c                	jne    10158e <cons_init+0x2a>
        cprintf("serial port does not exist!!\n");
  101582:	c7 04 24 29 37 10 00 	movl   $0x103729,(%esp)
  101589:	e8 84 ed ff ff       	call   100312 <cprintf>
    }
}
  10158e:	c9                   	leave  
  10158f:	c3                   	ret    
...
cons_putc(int c) {
  ...
  10159c:	e8 a3 fa ff ff       	call   101044 <lpt_putc>
    cga_putc(c);
  1015a1:	8b 45 08             	mov    0x8(%ebp),%eax
  1015a4:	89 04 24             	mov    %eax,(%esp)
  1015a7:	e8 d7 fa ff ff       	call   101083 <cga_putc>
    serial_putc(c);
  1015ac:	8b 45 08             	mov    0x8(%ebp),%eax
  1015af:	89 04 24             	mov    %eax,(%esp)
  1015b2:	e8 f9 fc ff ff       	call   1012b0 <serial_putc>
}
  1015b7:	c9                   	leave  
  1015b8:	c3                   	ret    
...
cons_getc(void) {
  ...
  1015bc:	83 ec 18             	sub    $0x18,%esp
    ...
    serial_intr();
  1015bf:	e8 cd fd ff ff       	call   101391 <serial_intr>
    kbd_intr();
  1015c4:	e8 6e ff ff ff       	call   101537 <kbd_intr>

    // grab the next character from the input buffer.
    if (cons.rpos != cons.wpos) {
  1015c9:	8b 15 80 f0 10 00    	mov    0x10f080,%edx
  1015cf:	a1 84 f0 10 00       	mov    0x10f084,%eax
  1015d4:	39 c2                	cmp    %eax,%edx
  1015d6:	74 36                	je     10160e <cons_getc+0x55>
        c = cons.buf[cons.rpos ++];
  1015d8:	a1 80 f0 10 00       	mov    0x10f080,%eax
  1015dd:	8d 50 01             	lea    0x1(%eax),%edx
  1015e0:	89 15 80 f0 10 00    	mov    %edx,0x10f080
  1015e6:	0f b6 80 80 ee 10 00 	movzbl 0x10ee80(%eax),%eax
  1015ed:	0f b6 c0             	movzbl %al,%eax
  1015f0:	89 45 f4             	mov    %eax,-0xc(%ebp)
        if (cons.rpos == CONSBUFSIZE) {
  1015f3:	a1 80 f0 10 00       	mov    0x10f080,%eax
  1015f8:	3d 00 02 00 00       	cmp    $0x200,%eax
  1015fd:	75 0a                	jne    101609 <cons_getc+0x50>
            cons.rpos = 0;
  1015ff:	c7 05 80 f0 10 00 00 	movl   $0x0,0x10f080
  101606:	00 00 00 
        }
        return c;
  101609:	8b 45 f4             	mov    -0xc(%ebp),%eax
  10160c:	eb 05                	jmp    101613 <cons_getc+0x5a>
    }
    return 0;
  10160e:	b8 00 00 00 00       	mov    $0x0,%eax
}
  101613:	c9                   	leave  
  101614:	c3                   	ret    

00101615 <intr_enable>:
#include <x86.h>
#include <intr.h>
...
pic_setmask(uint16_t mask) {
  ...
  101624:	83 ec 14             	sub    $0x14,%esp
  101627:	8b 45 08             	mov    0x8(%ebp),%eax
  10162a:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
    irq_mask = mask;
  10162e:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
  101632:	66 a3 50 e5 10 00    	mov    %ax,0x10e550
    if (did_init) {
  101638:	a1 8c f0 10 00       	mov    0x10f08c,%eax
  10163d:	85 c0                	test   %eax,%eax
  10163f:	74 36                	je     101677 <pic_setmask+0x56>
        outb(IO_PIC1 + 1, mask);
  101641:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
  101645:	0f b6 c0             	movzbl %al,%eax
  101648:	66 c7 45 fe 21 00    	movw   $0x21,-0x2(%ebp)
  10164e:	88 45 fd             	mov    %al,-0x3(%ebp)
            : "memory", "cc");
}
...
outb(uint16_t port, uint8_t data) {
    asm volatile ("outb %0, %1" :: "a" (data), "d" (port));
  101651:	0f b6 45 fd          	movzbl -0x3(%ebp),%eax
  101655:	0f b7 55 fe          	movzwl -0x2(%ebp),%edx
  101659:	ee                   	out    %al,(%dx)
        outb(IO_PIC2 + 1, mask >> 8);
  10165a:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
  10165e:	66 c1 e8 08          	shr    $0x8,%ax
  101662:	0f b6 c0             	movzbl %al,%eax
  101665:	66 c7 45 fa a1 00    	movw   $0xa1,-0x6(%ebp)
  10166b:	88 45 f9             	mov    %al,-0x7(%ebp)
  10166e:	0f b6 45 f9          	movzbl -0x7(%ebp),%eax
  101672:	0f b7 55 fa          	movzwl -0x6(%ebp),%edx
  101676:	ee                   	out    %al,(%dx)
    }
}
  101677:	c9                   	leave  
...
pic_enable(unsigned int irq) {
  ...
  10167c:	83 ec 04             	sub    $0x4,%esp
    pic_setmask(irq_mask & ~(1 << irq));
  10167f:	8b 45 08             	mov    0x8(%ebp),%eax
  101682:	ba 01 00 00 00       	mov    $0x1,%edx
  101687:	89 c1                	mov    %eax,%ecx
  101689:	d3 e2                	shl    %cl,%edx
  10168b:	89 d0                	mov    %edx,%eax
  10168d:	f7 d0                	not    %eax
  10168f:	89 c2                	mov    %eax,%edx
  101691:	0f b7 05 50 e5 10 00 	movzwl 0x10e550,%eax
  101698:	21 d0                	and    %edx,%eax
  10169a:	0f b7 c0             	movzwl %ax,%eax
  10169d:	89 04 24             	mov    %eax,(%esp)
  1016a0:	e8 7c ff ff ff       	call   101621 <pic_setmask>
}
  1016a5:	c9                   	leave  
  1016a6:	c3                   	ret    
...
pic_init(void) {
  ...
  1016aa:	83 ec 44             	sub    $0x44,%esp
    did_init = 1;
  1016ad:	c7 05 8c f0 10 00 01 	movl   $0x1,0x10f08c
  1016b4:	00 00 00 
  1016b7:	66 c7 45 fe 21 00    	movw   $0x21,-0x2(%ebp)
  1016bd:	c6 45 fd ff          	movb   $0xff,-0x3(%ebp)
  1016c1:	0f b6 45 fd          	movzbl -0x3(%ebp),%eax
  1016c5:	0f b7 55 fe          	movzwl -0x2(%ebp),%edx
  1016c9:	ee                   	out    %al,(%dx)
  1016ca:	66 c7 45 fa a1 00    	movw   $0xa1,-0x6(%ebp)
  1016d0:	c6 45 f9 ff          	movb   $0xff,-0x7(%ebp)
  1016d4:	0f b6 45 f9          	movzbl -0x7(%ebp),%eax
  1016d8:	0f b7 55 fa          	movzwl -0x6(%ebp),%edx
  1016dc:	ee                   	out    %al,(%dx)
  1016dd:	66 c7 45 f6 20 00    	movw   $0x20,-0xa(%ebp)
  1016e3:	c6 45 f5 11          	movb   $0x11,-0xb(%ebp)
  1016e7:	0f b6 45 f5          	movzbl -0xb(%ebp),%eax
  1016eb:	0f b7 55 f6          	movzwl -0xa(%ebp),%edx
  1016ef:	ee                   	out    %al,(%dx)
  1016f0:	66 c7 45 f2 21 00    	movw   $0x21,-0xe(%ebp)
  1016f6:	c6 45 f1 20          	movb   $0x20,-0xf(%ebp)
  1016fa:	0f b6 45 f1          	movzbl -0xf(%ebp),%eax
  1016fe:	0f b7 55 f2          	movzwl -0xe(%ebp),%edx
  101702:	ee                   	out    %al,(%dx)
  101703:	66 c7 45 ee 21 00    	movw   $0x21,-0x12(%ebp)
  101709:	c6 45 ed 04          	movb   $0x4,-0x13(%ebp)
  10170d:	0f b6 45 ed          	movzbl -0x13(%ebp),%eax
  101711:	0f b7 55 ee          	movzwl -0x12(%ebp),%edx
  101715:	ee                   	out    %al,(%dx)
  101716:	66 c7 45 ea 21 00    	movw   $0x21,-0x16(%ebp)
  10171c:	c6 45 e9 03          	movb   $0x3,-0x17(%ebp)
  101720:	0f b6 45 e9          	movzbl -0x17(%ebp),%eax
  101724:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
  101728:	ee                   	out    %al,(%dx)
  101729:	66 c7 45 e6 a0 00    	movw   $0xa0,-0x1a(%ebp)
  10172f:	c6 45 e5 11          	movb   $0x11,-0x1b(%ebp)
  101733:	0f b6 45 e5          	movzbl -0x1b(%ebp),%eax
  101737:	0f b7 55 e6          	movzwl -0x1a(%ebp),%edx
  10173b:	ee                   	out    %al,(%dx)
  10173c:	66 c7 45 e2 a1 00    	movw   $0xa1,-0x1e(%ebp)
  101742:	c6 45 e1 28          	movb   $0x28,-0x1f(%ebp)
  101746:	0f b6 45 e1          	movzbl -0x1f(%ebp),%eax
  10174a:	0f b7 55 e2          	movzwl -0x1e(%ebp),%edx
  10174e:	ee                   	out    %al,(%dx)
  10174f:	66 c7 45 de a1 00    	movw   $0xa1,-0x22(%ebp)
  101755:	c6 45 dd 02          	movb   $0x2,-0x23(%ebp)
  101759:	0f b6 45 dd          	movzbl -0x23(%ebp),%eax
  10175d:	0f b7 55 de          	movzwl -0x22(%ebp),%edx
  101761:	ee                   	out    %al,(%dx)
  101762:	66 c7 45 da a1 00    	movw   $0xa1,-0x26(%ebp)
  101768:	c6 45 d9 03          	movb   $0x3,-0x27(%ebp)
  10176c:	0f b6 45 d9          	movzbl -0x27(%ebp),%eax
  101770:	0f b7 55 da          	movzwl -0x26(%ebp),%edx
  101774:	ee                   	out    %al,(%dx)
  101775:	66 c7 45 d6 20 00    	movw   $0x20,-0x2a(%ebp)
  10177b:	c6 45 d5 68          	movb   $0x68,-0x2b(%ebp)
  10177f:	0f b6 45 d5          	movzbl -0x2b(%ebp),%eax
  101783:	0f b7 55 d6          	movzwl -0x2a(%ebp),%edx
  101787:	ee                   	out    %al,(%dx)
  101788:	66 c7 45 d2 20 00    	movw   $0x20,-0x2e(%ebp)
  10178e:	c6 45 d1 0a          	movb   $0xa,-0x2f(%ebp)
  101792:	0f b6 45 d1          	movzbl -0x2f(%ebp),%eax
  101796:	0f b7 55 d2          	movzwl -0x2e(%ebp),%edx
  10179a:	ee                   	out    %al,(%dx)
  10179b:	66 c7 45 ce a0 00    	movw   $0xa0,-0x32(%ebp)
  1017a1:	c6 45 cd 68          	movb   $0x68,-0x33(%ebp)
  1017a5:	0f b6 45 cd          	movzbl -0x33(%ebp),%eax
  1017a9:	0f b7 55 ce          	movzwl -0x32(%ebp),%edx
  1017ad:	ee                   	out    %al,(%dx)
  1017ae:	66 c7 45 ca a0 00    	movw   $0xa0,-0x36(%ebp)
  1017b4:	c6 45 c9 0a          	movb   $0xa,-0x37(%ebp)
  1017b8:	0f b6 45 c9          	movzbl -0x37(%ebp),%eax
  1017bc:	0f b7 55 ca          	movzwl -0x36(%ebp),%edx
  1017c0:	ee                   	out    %al,(%dx)
  ...
  1017c8:	66 83 f8 ff          	cmp    $0xffff,%ax
  1017cc:	74 12                	je     1017e0 <pic_init+0x139>
        pic_setmask(irq_mask);
  1017ce:	0f b7 05 50 e5 10 00 	movzwl 0x10e550,%eax
  1017d5:	0f b7 c0             	movzwl %ax,%eax
  1017d8:	89 04 24             	mov    %eax,(%esp)
  1017db:	e8 41 fe ff ff       	call   101621 <pic_setmask>
    }
}
  1017e0:	c9                   	leave  
  1017e1:	c3                   	ret    

001017e2 <print_ticks>:
#include <console.h>
#include <kdebug.h>
...
static void print_ticks() {
  ...
  1017e5:	83 ec 18             	sub    $0x18,%esp
    cprintf("%d ticks\n",TICK_NUM);
  1017e8:	c7 44 24 04 64 00 00 	movl   $0x64,0x4(%esp)
  1017ef:	00 
  1017f0:	c7 04 24 60 37 10 00 	movl   $0x103760,(%esp)
  1017f7:	e8 16 eb ff ff       	call   100312 <cprintf>
#ifdef DEBUG_GRADE
    cprintf("End of Test.\n");
...
idt_init(void) {
  ...
  101801:	83 ec 10             	sub    $0x10,%esp
      ...
      */
	   extern uintptr_t __vectors[];
	    int i;
	    for (i = 0; i < 256; i++)
  101804:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
  10180b:	e9 e2 00 00 00       	jmp    1018f2 <idt_init+0xf4>
	        SETGATE(idt[i], 0, GD_KTEXT, __vectors[i], i == T_SYSCALL ? DPL_USER : DPL_KERNEL);
  101810:	8b 45 fc             	mov    -0x4(%ebp),%eax
  101813:	8b 04 85 e0 e5 10 00 	mov    0x10e5e0(,%eax,4),%eax
  10181a:	89 c2                	mov    %eax,%edx
  10181c:	8b 45 fc             	mov    -0x4(%ebp),%eax
  10181f:	66 89 14 c5 a0 f0 10 	mov    %dx,0x10f0a0(,%eax,8)
  101826:	00 
  101827:	8b 45 fc             	mov    -0x4(%ebp),%eax
  10182a:	66 c7 04 c5 a2 f0 10 	movw   $0x8,0x10f0a2(,%eax,8)
  101831:	00 08 00 
  101834:	8b 45 fc             	mov    -0x4(%ebp),%eax
  101837:	0f b6 14 c5 a4 f0 10 	movzbl 0x10f0a4(,%eax,8),%edx
  10183e:	00 
  10183f:	83 e2 e0             	and    $0xffffffe0,%edx
  101842:	88 14 c5 a4 f0 10 00 	mov    %dl,0x10f0a4(,%eax,8)
  101849:	8b 45 fc             	mov    -0x4(%ebp),%eax
  10184c:	0f b6 14 c5 a4 f0 10 	movzbl 0x10f0a4(,%eax,8),%edx
  101853:	00 
  101854:	83 e2 1f             	and    $0x1f,%edx
  101857:	88 14 c5 a4 f0 10 00 	mov    %dl,0x10f0a4(,%eax,8)
  10185e:	8b 45 fc             	mov    -0x4(%ebp),%eax
  101861:	0f b6 14 c5 a5 f0 10 	movzbl 0x10f0a5(,%eax,8),%edx
  101868:	00 
  101869:	83 e2 f0             	and    $0xfffffff0,%edx
  10186c:	83 ca 0e             	or     $0xe,%edx
  10186f:	88 14 c5 a5 f0 10 00 	mov    %dl,0x10f0a5(,%eax,8)
  101876:	8b 45 fc             	mov    -0x4(%ebp),%eax
  101879:	0f b6 14 c5 a5 f0 10 	movzbl 0x10f0a5(,%eax,8),%edx
  101880:	00 
  101881:	83 e2 ef             	and    $0xffffffef,%edx
  101884:	88 14 c5 a5 f0 10 00 	mov    %dl,0x10f0a5(,%eax,8)
  10188b:	81 7d fc 80 00 00 00 	cmpl   $0x80,-0x4(%ebp)
  101892:	75 07                	jne    10189b <idt_init+0x9d>
  101894:	ba 03 00 00 00       	mov    $0x3,%edx
  101899:	eb 05                	jmp    1018a0 <idt_init+0xa2>
  10189b:	ba 00 00 00 00       	mov    $0x0,%edx
  1018a0:	8b 45 fc             	mov    -0x4(%ebp),%eax
  1018a3:	83 e2 03             	and    $0x3,%edx
  1018a6:	89 d1                	mov    %edx,%ecx
  1018a8:	c1 e1 05             	shl    $0x5,%ecx
  1018ab:	0f b6 14 c5 a5 f0 10 	movzbl 0x10f0a5(,%eax,8),%edx
  1018b2:	00 
  1018b3:	83 e2 9f             	and    $0xffffff9f,%edx
  1018b6:	09 ca                	or     %ecx,%edx
  ...
  1018f2:	81 7d fc ff 00 00 00 	cmpl   $0xff,-0x4(%ebp)
  1018f9:	0f 8e 11 ff ff ff    	jle    101810 <idt_init+0x12>
  1018ff:	c7 45 f8 60 e5 10 00 	movl   $0x10e560,-0x8(%ebp)
    return ebp;
}
...
lidt(struct pseudodesc *pd) {
    asm volatile ("lidt (%0)" :: "r" (pd));
  101906:	8b 45 f8             	mov    -0x8(%ebp),%eax
  101909:	0f 01 18             	lidtl  (%eax)
	        SETGATE(idt[i], 0, GD_KTEXT, __vectors[i], i == T_SYSCALL ? DPL_USER : DPL_KERNEL);
	    lidt(&idt_pd);
}
  10190c:	c9                   	leave  
...
trapname(int trapno) {
  ...
  101914:	83 f8 13             	cmp    $0x13,%eax
  101917:	77 0c                	ja     101925 <trapname+0x17>
        return excnames[trapno];
  101919:	8b 45 08             	mov    0x8(%ebp),%eax
  10191c:	8b 04 85 c0 3a 10 00 	mov    0x103ac0(,%eax,4),%eax
  101923:	eb 18                	jmp    10193d <trapname+0x2f>
    }
    if (trapno >= IRQ_OFFSET && trapno < IRQ_OFFSET + 16) {
  101925:	83 7d 08 1f          	cmpl   $0x1f,0x8(%ebp)
  101929:	7e 0d                	jle    101938 <trapname+0x2a>
  10192b:	83 7d 08 2f          	cmpl   $0x2f,0x8(%ebp)
  10192f:	7f 07                	jg     101938 <trapname+0x2a>
        return "Hardware Interrupt";
  101931:	b8 6a 37 10 00       	mov    $0x10376a,%eax
  101936:	eb 05                	jmp    10193d <trapname+0x2f>
    }
    return "(unknown trap)";
  101938:	b8 7d 37 10 00       	mov    $0x10377d,%eax
}
  10193d:	5d                   	pop    %ebp
  10193e:	c3                   	ret    

0010193f <trap_in_kernel>:
...
trap_in_kernel(struct trapframe *tf) {
  ...
  101942:	8b 45 08             	mov    0x8(%ebp),%eax
  101945:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  101949:	66 83 f8 08          	cmp    $0x8,%ax
  10194d:	0f 94 c0             	sete   %al
  101950:	0f b6 c0             	movzbl %al,%eax
}
  101953:	5d                   	pop    %ebp
  101954:	c3                   	ret    

00101955 <print_trapframe>:
...
print_trapframe(struct trapframe *tf) {
  ...
  101958:	83 ec 28             	sub    $0x28,%esp
    cprintf("trapframe at %p\n", tf);
  10195b:	8b 45 08             	mov    0x8(%ebp),%eax
  10195e:	89 44 24 04          	mov    %eax,0x4(%esp)
  101962:	c7 04 24 be 37 10 00 	movl   $0x1037be,(%esp)
  101969:	e8 a4 e9 ff ff       	call   100312 <cprintf>
    print_regs(&tf->tf_regs);
  10196e:	8b 45 08             	mov    0x8(%ebp),%eax
  101971:	89 04 24             	mov    %eax,(%esp)
  101974:	e8 a1 01 00 00       	call   101b1a <print_regs>
    cprintf("  ds   0x----%04x\n", tf->tf_ds);
  101979:	8b 45 08             	mov    0x8(%ebp),%eax
  10197c:	0f b7 40 2c          	movzwl 0x2c(%eax),%eax
  101980:	0f b7 c0             	movzwl %ax,%eax
  101983:	89 44 24 04          	mov    %eax,0x4(%esp)
  101987:	c7 04 24 cf 37 10 00 	movl   $0x1037cf,(%esp)
  10198e:	e8 7f e9 ff ff       	call   100312 <cprintf>
    cprintf("  es   0x----%04x\n", tf->tf_es);
  101993:	8b 45 08             	mov    0x8(%ebp),%eax
  101996:	0f b7 40 28          	movzwl 0x28(%eax),%eax
  10199a:	0f b7 c0             	movzwl %ax,%eax
  10199d:	89 44 24 04          	mov    %eax,0x4(%esp)
  1019a1:	c7 04 24 e2 37 10 00 	movl   $0x1037e2,(%esp)
  1019a8:	e8 65 e9 ff ff       	call   100312 <cprintf>
    cprintf("  fs   0x----%04x\n", tf->tf_fs);
  1019ad:	8b 45 08             	mov    0x8(%ebp),%eax
  1019b0:	0f b7 40 24          	movzwl 0x24(%eax),%eax
  1019b4:	0f b7 c0             	movzwl %ax,%eax
  1019b7:	89 44 24 04          	mov    %eax,0x4(%esp)
  1019bb:	c7 04 24 f5 37 10 00 	movl   $0x1037f5,(%esp)
  1019c2:	e8 4b e9 ff ff       	call   100312 <cprintf>
    cprintf("  gs   0x----%04x\n", tf->tf_gs);
  1019c7:	8b 45 08             	mov    0x8(%ebp),%eax
  1019ca:	0f b7 40 20          	movzwl 0x20(%eax),%eax
  1019ce:	0f b7 c0             	movzwl %ax,%eax
  1019d1:	89 44 24 04          	mov    %eax,0x4(%esp)
  1019d5:	c7 04 24 08 38 10 00 	movl   $0x103808,(%esp)
  1019dc:	e8 31 e9 ff ff       	call   100312 <cprintf>
    cprintf("  trap 0x%08x %s\n", tf->tf_trapno, trapname(tf->tf_trapno));
  1019e1:	8b 45 08             	mov    0x8(%ebp),%eax
  1019e4:	8b 40 30             	mov    0x30(%eax),%eax
  1019e7:	89 04 24             	mov    %eax,(%esp)
  1019ea:	e8 1f ff ff ff       	call   10190e <trapname>
  1019ef:	8b 55 08             	mov    0x8(%ebp),%edx
  1019f2:	8b 52 30             	mov    0x30(%edx),%edx
  1019f5:	89 44 24 08          	mov    %eax,0x8(%esp)
  1019f9:	89 54 24 04          	mov    %edx,0x4(%esp)
  1019fd:	c7 04 24 1b 38 10 00 	movl   $0x10381b,(%esp)
  101a04:	e8 09 e9 ff ff       	call   100312 <cprintf>
    cprintf("  err  0x%08x\n", tf->tf_err);
  101a09:	8b 45 08             	mov    0x8(%ebp),%eax
  101a0c:	8b 40 34             	mov    0x34(%eax),%eax
  101a0f:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a13:	c7 04 24 2d 38 10 00 	movl   $0x10382d,(%esp)
  101a1a:	e8 f3 e8 ff ff       	call   100312 <cprintf>
    cprintf("  eip  0x%08x\n", tf->tf_eip);
  101a1f:	8b 45 08             	mov    0x8(%ebp),%eax
  101a22:	8b 40 38             	mov    0x38(%eax),%eax
  101a25:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a29:	c7 04 24 3c 38 10 00 	movl   $0x10383c,(%esp)
  101a30:	e8 dd e8 ff ff       	call   100312 <cprintf>
    cprintf("  cs   0x----%04x\n", tf->tf_cs);
  ...
  101a43:	c7 04 24 4b 38 10 00 	movl   $0x10384b,(%esp)
  101a4a:	e8 c3 e8 ff ff       	call   100312 <cprintf>
    cprintf("  flag 0x%08x ", tf->tf_eflags);
  101a4f:	8b 45 08             	mov    0x8(%ebp),%eax
  101a52:	8b 40 40             	mov    0x40(%eax),%eax
  101a55:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a59:	c7 04 24 5e 38 10 00 	movl   $0x10385e,(%esp)
  101a60:	e8 ad e8 ff ff       	call   100312 <cprintf>

    int i, j;
    for (i = 0, j = 1; i < sizeof(IA32flags) / sizeof(IA32flags[0]); i ++, j <<= 1) {
  101a65:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  101a6c:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
  101a73:	eb 3e                	jmp    101ab3 <print_trapframe+0x15e>
        if ((tf->tf_eflags & j) && IA32flags[i] != NULL) {
  101a75:	8b 45 08             	mov    0x8(%ebp),%eax
  101a78:	8b 50 40             	mov    0x40(%eax),%edx
  101a7b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  101a7e:	21 d0                	and    %edx,%eax
  101a80:	85 c0                	test   %eax,%eax
  101a82:	74 28                	je     101aac <print_trapframe+0x157>
  101a84:	8b 45 f4             	mov    -0xc(%ebp),%eax
  101a87:	8b 04 85 80 e5 10 00 	mov    0x10e580(,%eax,4),%eax
  101a8e:	85 c0                	test   %eax,%eax
  101a90:	74 1a                	je     101aac <print_trapframe+0x157>
            cprintf("%s,", IA32flags[i]);
  101a92:	8b 45 f4             	mov    -0xc(%ebp),%eax
  101a95:	8b 04 85 80 e5 10 00 	mov    0x10e580(,%eax,4),%eax
  101a9c:	89 44 24 04          	mov    %eax,0x4(%esp)
  101aa0:	c7 04 24 6d 38 10 00 	movl   $0x10386d,(%esp)
  101aa7:	e8 66 e8 ff ff       	call   100312 <cprintf>
    ...
    int i, j;
    for (i = 0, j = 1; i < sizeof(IA32flags) / sizeof(IA32flags[0]); i ++, j <<= 1) {
  101aac:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  101ab0:	d1 65 f0             	shll   -0x10(%ebp)
  101ab3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  101ab6:	83 f8 17             	cmp    $0x17,%eax
  101ab9:	76 ba                	jbe    101a75 <print_trapframe+0x120>
        if ((tf->tf_eflags & j) && IA32flags[i] != NULL) {
            cprintf("%s,", IA32flags[i]);
        }
    }
  ...
  101ac1:	25 00 30 00 00       	and    $0x3000,%eax
  101ac6:	c1 e8 0c             	shr    $0xc,%eax
  101ac9:	89 44 24 04          	mov    %eax,0x4(%esp)
  101acd:	c7 04 24 71 38 10 00 	movl   $0x103871,(%esp)
  101ad4:	e8 39 e8 ff ff       	call   100312 <cprintf>

    if (!trap_in_kernel(tf)) {
  101ad9:	8b 45 08             	mov    0x8(%ebp),%eax
  101adc:	89 04 24             	mov    %eax,(%esp)
  101adf:	e8 5b fe ff ff       	call   10193f <trap_in_kernel>
  101ae4:	85 c0                	test   %eax,%eax
  101ae6:	75 30                	jne    101b18 <print_trapframe+0x1c3>
        cprintf("  esp  0x%08x\n", tf->tf_esp);
  101ae8:	8b 45 08             	mov    0x8(%ebp),%eax
  101aeb:	8b 40 44             	mov    0x44(%eax),%eax
  101aee:	89 44 24 04          	mov    %eax,0x4(%esp)
  101af2:	c7 04 24 7a 38 10 00 	movl   $0x10387a,(%esp)
  101af9:	e8 14 e8 ff ff       	call   100312 <cprintf>
        cprintf("  ss   0x----%04x\n", tf->tf_ss);
  101afe:	8b 45 08             	mov    0x8(%ebp),%eax
  101b01:	0f b7 40 48          	movzwl 0x48(%eax),%eax
  101b05:	0f b7 c0             	movzwl %ax,%eax
  101b08:	89 44 24 04          	mov    %eax,0x4(%esp)
  101b0c:	c7 04 24 89 38 10 00 	movl   $0x103889,(%esp)
  101b13:	e8 fa e7 ff ff       	call   100312 <cprintf>
    }
}
  101b18:	c9                   	leave  
  101b19:	c3                   	ret    
...
trap_dispatch(struct trapframe *tf) {
  ...
  101be0:	77 1d                	ja     101bff <trap_dispatch+0x2e>
  101be2:	83 f8 2e             	cmp    $0x2e,%eax
  101be5:	0f 83 ed 00 00 00    	jae    101cd8 <trap_dispatch+0x107>
  101beb:	83 f8 21             	cmp    $0x21,%eax
  101bee:	74 6e                	je     101c5e <trap_dispatch+0x8d>
  101bf0:	83 f8 24             	cmp    $0x24,%eax
  101bf3:	74 43                	je     101c38 <trap_dispatch+0x67>
  101bf5:	83 f8 20             	cmp    $0x20,%eax
  101bf8:	74 13                	je     101c0d <trap_dispatch+0x3c>
  101bfa:	e9 a1 00 00 00       	jmp    101ca0 <trap_dispatch+0xcf>
  101bff:	83 e8 78             	sub    $0x78,%eax
  101c02:	83 f8 01             	cmp    $0x1,%eax
  101c05:	0f 87 95 00 00 00    	ja     101ca0 <trap_dispatch+0xcf>
  101c0b:	eb 77                	jmp    101c84 <trap_dispatch+0xb3>
         ...
         */
    	if (++ticks == TICK_NUM) {
  101c0d:	a1 08 f9 10 00       	mov    0x10f908,%eax
  101c12:	83 c0 01             	add    $0x1,%eax
  101c15:	a3 08 f9 10 00       	mov    %eax,0x10f908
  101c1a:	83 f8 64             	cmp    $0x64,%eax
  101c1d:	75 14                	jne    101c33 <trap_dispatch+0x62>
    		print_ticks();
  101c1f:	e8 be fb ff ff       	call   1017e2 <print_ticks>
    		ticks = 0;
  101c24:	c7 05 08 f9 10 00 00 	movl   $0x0,0x10f908
  101c2b:	00 00 00 
    	}
        break;
  101c2e:	e9 a6 00 00 00       	jmp    101cd9 <trap_dispatch+0x108>
  101c33:	e9 a1 00 00 00       	jmp    101cd9 <trap_dispatch+0x108>
    case IRQ_OFFSET + IRQ_COM1:
        c = cons_getc();
  101c38:	e8 7c f9 ff ff       	call   1015b9 <cons_getc>
  ...
  101c50:	c7 04 24 14 39 10 00 	movl   $0x103914,(%esp)
  101c57:	e8 b6 e6 ff ff       	call   100312 <cprintf>
        break;
  101c5c:	eb 7b                	jmp    101cd9 <trap_dispatch+0x108>
    case IRQ_OFFSET + IRQ_KBD:
        c = cons_getc();
  101c5e:	e8 56 f9 ff ff       	call   1015b9 <cons_getc>
  ...
  101c76:	c7 04 24 26 39 10 00 	movl   $0x103926,(%esp)
  101c7d:	e8 90 e6 ff ff       	call   100312 <cprintf>
        break;
  101c82:	eb 55                	jmp    101cd9 <trap_dispatch+0x108>
    //LAB1 CHALLENGE 1 : YOUR CODE you should modify below codes.
    case T_SWITCH_TOU:
    case T_SWITCH_TOK:
        panic("T_SWITCH_** ??\n");
  101c84:	c7 44 24 08 35 39 10 	movl   $0x103935,0x8(%esp)
  101c8b:	00 
  101c8c:	c7 44 24 04 ab 00 00 	movl   $0xab,0x4(%esp)
  101c93:	00 
  101c94:	c7 04 24 45 39 10 00 	movl   $0x103945,(%esp)
  101c9b:	e8 fb ef ff ff       	call   100c9b <__panic>
  ...
  101caf:	75 28                	jne    101cd9 <trap_dispatch+0x108>
            print_trapframe(tf);
  101cb1:	8b 45 08             	mov    0x8(%ebp),%eax
  101cb4:	89 04 24             	mov    %eax,(%esp)
  101cb7:	e8 99 fc ff ff       	call   101955 <print_trapframe>
            panic("unexpected trap in kernel.\n");
  101cbc:	c7 44 24 08 56 39 10 	movl   $0x103956,0x8(%esp)
  101cc3:	00 
  101cc4:	c7 44 24 04 b5 00 00 	movl   $0xb5,0x4(%esp)
  101ccb:	00 
  101ccc:	c7 04 24 45 39 10 00 	movl   $0x103945,(%esp)
  101cd3:	e8 c3 ef ff ff       	call   100c9b <__panic>
        panic("T_SWITCH_** ??\n");
        break;
...
trap(struct trapframe *tf) {
  ...
  101ce7:	e8 e5 fe ff ff       	call   101bd1 <trap_dispatch>
}
  101cec:	c9                   	leave  
  101ced:	c3                   	ret    
...
gdt_init(void) {
  ...
  1027bb:	b8 20 f9 10 00       	mov    $0x10f920,%eax
  1027c0:	05 00 04 00 00       	add    $0x400,%eax
  1027c5:	a3 a4 f8 10 00       	mov    %eax,0x10f8a4
    ts.ts_ss0 = KERNEL_DS;
  1027ca:	66 c7 05 a8 f8 10 00 	movw   $0x10,0x10f8a8
  1027d1:	10 00 
  ...
  1027da:	68 00 
  1027dc:	b8 a0 f8 10 00       	mov    $0x10f8a0,%eax
  1027e1:	66 a3 0a ea 10 00    	mov    %ax,0x10ea0a
  1027e7:	b8 a0 f8 10 00       	mov    $0x10f8a0,%eax
  ...
  10287e:	b8 a0 f8 10 00       	mov    $0x10f8a0,%eax
